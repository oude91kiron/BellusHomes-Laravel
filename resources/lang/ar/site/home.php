...
return [
    ...
    'Check our best projects and the opportunities we are providing' => 'تحقق من أفضل مشاريعنا والفرص التي نقدمها',
    'More Projects' => 'المزيد من المشاريع',
    
    'What Are you Looking For?' => 'ماذا تبحث',
    'Check our services, And don\'t hesitate to cnotact us.' => 'تصفح خدماتنا, ولا تتردد بالتواصل معنا للحصول على استشارة مجانية',
    'Apartments' => 'شقة سكنية',
    'We provide you the best opportunity to buy or sell an apartment in istanbul and other cities around Turkey' => 'نحن نقدم لك أفضل فرصة لشراء أو بيع شقة في اسطنبول ومدن أخرى في جميع أنحاء تركيا',
    ...
    'MORE DETAILES' => 'المزيد من التفاصيل',
