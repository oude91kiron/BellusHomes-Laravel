								...
								<div class="x_content">
									...
									@csrf
										...
										<div class="form-group mt-1">
											<input type="radio" name="type" value="1" checked class="switchery" data-color="success" onclick="show1();" />
									 			<label class="card-title ml-1">Category</label>
								 		</div>
									...
									<div class="form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="button"><a style="color:#fff" href="{{route('admin.dashboard')}}">Cancel</a></button>
