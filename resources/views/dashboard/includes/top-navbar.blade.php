              ...
              <nav class="nav navbar-nav">
                <ul class=" navbar-right">
                    <li class="nav-item dropdown open" style="padding-left: 15px;">
                        ...
                        @if(App()->getLocale() == 'en') <img src="{{asset('assets/arapca.png')}}"> @else <img src="{{asset('assets/english.png')}}"></i>@endif
                        </a>
                        <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">Admin</a>
