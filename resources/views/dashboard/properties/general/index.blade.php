                              ...
                              <td>
                                  <div class="btn-group" role="group"
                                      ...
                                      <a href="{{route('admin.properties.features',$property -> id)}}"
                                        ...
                                        <a href="{{route('admin.properties.general',$property -> id)}}"
                                          class="btn btn-outline-success btn-min-width btn-dangerww box-shadow-3 ml-5 mb-1">Update</a>
                                   
                                        <a href="{{route('admin.properties.delete',$property -> id)}}"
                                           class="btn btn-outline-danger btn-min-width btn-dangerww box-shadow-3 ml-2 mb-1">Delete</a>     
